...
var baseportdata;
$.ajax({
    url: 'http://geospatialapi-noypimaps.rhcloud.com/ppaapi/baseports/',
    dataType: 'json',
    async: false,
...
var roadsdata;
$.ajax({
    url: 'http://geospatialapi-noypimaps.rhcloud.com/ppaapi/batangasroads/',
    dataType: 'json',
    async: false,
    success: function(data) {
        roadsdata = data;
...
var boundarydata;
$.ajax({
    url: 'http://geospatialapi-noypimaps.rhcloud.com/ppaapi/batangasboundary/',
    dataType: 'json',
    async: false,
    success: function(data) {
        boundarydata = data;
...
var coastlinedata;
$.ajax({
    url: 'http://geospatialapi-noypimaps.rhcloud.com/ppaapi/batangascoastline/',
    dataType: 'json',
    async: false,
    success: function(data) {
        coastlinedata = data;
...
var facilitiesdata;
$.ajax({
    url: 'http://geospatialapi-noypimaps.rhcloud.com/ppaapi/batangasfacilities/',
    dataType: 'json',
    async: false,
    success: function(data) {
        facilitiesdata = data;
