L.Control.ZoomOutBox = L.Control.extend({
    _active: false,
    _map: null,
    ...
    onAdd: function (map) {
        this._map = map;
        this._container = L.DomUtil.create('div', 'leaflet-zoomout-box-control leaflet-bar');
        this._container.title = "Zoom out from specific area";
